...
public class MatchManager : MonoBehaviour
{
    ...
    private void setAOETargets()
    {
        foreach (Agent agent in mRedAgents)
        {
            agent.setAOETargetList(mBlueAgentsLocations, mRedAgentsLocations);
        }

        foreach (Agent agent in mBlueAgents)
        {
            agent.setAOETargetList(mRedAgentsLocations, mBlueAgentsLocations);
        }
    }
