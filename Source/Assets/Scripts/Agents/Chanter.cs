...
public class Chanter : Agent
{
    ...
    public Chanter(string team, int agentId, int gridId) : base(team, "chanter", agentId, gridId)
    {
    ...
    protected override void loadParameters()
    {
        ...
        mHealth = settings.chanterHealth;
        mDefense = settings.chanterDefense;
        mOffenseBuff = settings.chanterOffenseBuff;
        mDefenseBuff = settings.chanterDefenseBuff;
    }
